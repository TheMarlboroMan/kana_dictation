...
#include "../base_director_estados.h"
#include "../eventos.h"
...
class Kernel_base
{
	...
	void establecer_interprete_eventos(Interface_interprete_eventos& IE);
	void establecer_director_estados(Base_director_estados& DE);
	void registrar_controlador(int, Interface_controlador& I);
	void preparar_loop();
	bool loop();
	...
	Interface_controlador * IC;
	Base_director_estados * DE;
	Interface_interprete_eventos * IE;
